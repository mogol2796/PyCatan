...
class PriorityBuilderAgent(AgentInterface):
    """
    Agent that behaves randomly in all phases except the building phase,
    where it prioritizes building a City, then a Town, then a Road.
    """
    ...
    def on_build_phase(self, board_instance):
        ...
        # 4. Priority: If we cannot build any of those, perform no action. 
        # (Excludes purchasing development cards as per your logic)
        return None
